...
<script>
// *代表将echarts里面的全部按需导入进来，收集到一个对象中，并换名为echarts
// 比如把api下的user.js中的按需导出的内容全部按需导入进来，直接写*然后更名为obj
// import * as obj from '@/api/user'
// console.log(obj)  obj.getUser()  obj.login()
